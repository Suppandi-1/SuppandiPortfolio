        ...
        <div className="nova-square p-1  pb-4 flex  h-full w-full flex-col lg:flex-row justify-around text-p1" >
            ...
            <section className="m1   pt-24  w-full flex sm:flex-col items-center justify-around">
                <div className=" relative w-fit p-2 sm:p-3  lg:p-4 h-44 sm:h-[19rem] md:h-[21rem] lg:h-96   flex justify-center items-center">
                    <h2 className="      lg:pt-2  font-sans font-bold text-center text-3xl sm:text-4xl md:text-5xl xl:text-6xl ">About <span className="font-sans text-p5">Me</span></h2>
                    
                    <img  className=" w-32  sm:w-60  md:w-64  lg:w-72  rounded-full border-solid border-4 border-p5 " src={image} alt="image" />
            ...
            <section className=" m-4  lg:pt-24 justify-center items-center flex flex-col w-auto h-auto">
                ...
                <div className=" h-full p-0  items-center flex flex-col ">
                    ...
                    <div className="   flex flex-col justify-center h-full  ">
                        <div className="border-0 border-solid border-l-4 md:border-l-8 border-p4 pl-2 m-1 lg:m-2   text-xl "><h1 className =" m-1 lg:m-2  lg:p-2  text-p5 font-bold text-lg sm:text-xl md:text-2xl flex items-center">Web Development: <box-icon color="#81B29A" type='logo' name='html5'></box-icon>  <box-icon name='css3'color="#81B29A" type='logo' ></box-icon>   <box-icon type='logo' name='tailwind-css' color="#81B29A"></box-icon> <box-icon color="#81B29A" name='react' type='logo' ></box-icon></h1><p className =" lg:m-2 lg:p-2  text-p1 text-base sm:text-lg  md:text-xl">Proficient in React.js and Node.js, creating responsive and efficient web applications.</p></div>
                        <div className="border-0 border-solid border-l-4 md:border-l-8 border-p4 pl-2 m-1 lg:m-2   text-xl "><h1 className =" m-1 lg:m-2  lg:p-2  text-p5 font-bold text-lg sm:text-xl md:text-2xl flex items-center">App Development: <box-icon name='android' color="#81B29A" type='logo' ></box-icon>  <box-icon color="#81B29A" name='devices' ></box-icon> <box-icon name='code' color="#81B29A" ></box-icon></h1><p className =" lg:m-2 lg:p-2  text-p1 text-base sm:text-lg  md:text-xl"> Skilled in Kotlin and Jetpack Compose, delivering high-quality Android applications.</p></div>
                        <div className="border-0 border-solid border-l-4 md:border-l-8 border-p4 pl-2 m-1 lg:m-2   text-xl "><h1 className =" m-1 lg:m-2  lg:p-2  text-p5 font-bold text-lg sm:text-xl md:text-2xl flex items-center">Aeromodelling: <box-icon color="#81B29A" name='paper-plane' ></box-icon> <box-icon color="#81B29A"name='plane-alt' type="solid" ></box-icon>  <box-icon color="#81B29A"name='blender' type='logo' ></box-icon>     </h1><p className =" lg:m-2 lg:p-2  text-p1 text-base sm:text-lg  md:text-xl">Experienced in designing and developing advanced aeromodelling projects.</p></div>
                        <div className="border-0 border-solid border-l-4 md:border-l-8 border-p4 pl-2 m-1 lg:m-2   text-xl "><h1 className =" m-1 lg:m-2  lg:p-2  text-p5 font-bold text-lg sm:text-xl md:text-2xl flex items-center">Automation: <box-icon color="#81B29A" name='javascript' type='logo' ></box-icon>  <box-icon color="#81B29A"name='nodejs' type='logo' ></box-icon>  <box-icon name='firefox' type="logo" color='#81B29A' ></box-icon>  </h1><p className =" lg:m-2 lg:p-2  text-p1 text-base sm:text-lg  md:text-xl">Developed Selenium bots using Node.js to automate tasks on platforms like Pinterest and Instagram.</p></div>                        
                        <div className="border-0 border-solid border-l-4 md:border-l-8 border-p4 pl-2 m-1 lg:m-2   text-xl "><h1 className =" m-1 lg:m-2  lg:p-2  text-p5 font-bold text-lg sm:text-xl md:text-2xl flex items-center">CAD Modeling:  <box-icon color="#81B29A"name='blender' type='logo' ></box-icon>     </h1><p className =" lg:m-2 lg:p-2  text-p1 text-base sm:text-lg  md:text-xl">Proficient in Fusion 360 for creating detailed and precise CAD models, particularly in aeromodelling.</p></div>
