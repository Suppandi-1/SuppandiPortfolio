...
const About = () => {
    ...
    return ( 
        ...
        <div className="p-1  pb-4 flex  h-full w-full flex-col lg:flex-row justify-around" >
            {/* left part  */}
            <section className=" pt-24  w-full flex flex-col items-center justify-center">
                <div className=" relative w-fit p-2 sm:p-3  lg:p-4 h-60 sm:h-[19rem] md:h-[21rem] lg:h-96   flex justify-center items-center">
                    ...
                    <img  className=" w-44  sm:w-60  md:w-64  lg:w-72  rounded-full border_neone " src={image} alt="image" />
                ...
                <div className=" sm:px-8  w-full">
                    ...
                    <div className=" flex items-center justify-center  w-full my-0 py-0 ">
                        <Link to="/Projects" className=" btn-box relative inline-flex justify-center items-center rounded-2xl textt-lg sm:text-xl md:text-2xl w-36 h-12 sm:w-40 sm:h-16 md:w-48 md:h-20 bg-cyan-600 font-extrabold z-10 m-[.12rem] sm:m-1 md:m-3">My Projects</Link>
                        <Link to="/Blogs"    className=" btn-box relative inline-flex justify-center items-center rounded-2xl textt-lg sm:text-xl md:text-2xl w-36 h-12 sm:w-40 sm:h-16 md:w-48 md:h-20 bg-cyan-600 font-extrabold z-10 m-[.12rem] sm:m-1 md:m-3">My Blogs   </Link>
                    </div>
                </div>
            {/* right part  */}
            ...
            <section className="  lg:pt-24 justify-center items-center flex flex-col w-auto h-auto">
                ...
                <div className=" h-full p-0  items-center flex flex-col ">
                    ...
                    <div className="  flex flex-col justify-center h-full  ">
                        <div className=" m-1 lg:m-2   text-xl "><h1 className =" m-1 lg:m-2  lg:p-2  color-palette3 font-bold text-lg sm:text-xl md:text-2xl">Web Development:    </h1><p className =" lg:m-2 lg:p-2  color-palette2 text-base sm:text-lg  md:text-xl">Proficient in React.js and Node.js, creating responsive and efficient web applications.</p></div>
                        <div className=" m-1 lg:m-2   text-xl "><h1 className =" m-1 lg:m-2  lg:p-2  color-palette3 font-bold text-lg sm:text-xl md:text-2xl">App Development:    </h1><p className =" lg:m-2 lg:p-2  color-palette2 text-base sm:text-lg  md:text-xl">Skilled in Kotlin and Jetpack Compose, delivering high-quality Android applications.</p></div>
                        <div className=" m-1 lg:m-2   text-xl "><h1 className =" m-1 lg:m-2  lg:p-2  color-palette3 font-bold text-lg sm:text-xl md:text-2xl">Aeromodelling:      </h1><p className =" lg:m-2 lg:p-2  color-palette2 text-base sm:text-lg  md:text-xl">Experienced in designing and developing advanced aeromodelling projects.</p></div>
